...
func decodeSdkDep(ctx android.EarlyModuleContext, sdkContext sdkContext) sdkDep {
	...
	toModule := func(modules []string, res string, platformRes string, aidl android.Path) sdkDep {
		return sdkDep{
			useModule:          true,
	...
	case sdkPrivate:
		return sdkDep{
			...
			platformResModule:   "com.evervolv.platform-res",
		}
	case sdkNone:
	...
	case sdkPublic:
		return toModule([]string{"android_stubs_current"}, "framework-res", "com.evervolv.platform-res", sdkFrameworkAidlPath(ctx))
	case sdkSystem:
		return toModule([]string{"android_system_stubs_current"}, "framework-res", "com.evervolv.platform-res", sdkFrameworkAidlPath(ctx))
	case sdkTest:
		return toModule([]string{"android_test_stubs_current"}, "framework-res", "com.evervolv.platform-res", sdkFrameworkAidlPath(ctx))
	case sdkCore:
		return toModule([]string{"core.current.stubs"}, "", "", nil)
	case sdkModule:
		// TODO(146757305): provide .apk and .aidl that have more APIs for modules
		return toModule([]string{"android_module_lib_stubs_current"}, "framework-res", "com.evervolv.platform-res", nonUpdatableFrameworkAidlPath(ctx))
	case sdkSystemServer:
		// TODO(146757305): provide .apk and .aidl that have more APIs for modules
		return toModule([]string{"android_system_server_stubs_current"}, "framework-res", "com.evervolv.platform-res", sdkFrameworkAidlPath(ctx))
	default:
