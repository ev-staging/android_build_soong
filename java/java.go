...
var (
	...
	platformResTag    = dependencyTag{name: "com.evervolv.platform-res"}
...
func (j *Module) deps(ctx android.BottomUpMutatorContext) {
	if ctx.Device() {
		...
		if ctx.ModuleName() == "com.evervolv.platform" || ctx.ModuleName() == "com.evervolv.platform.internal" {
			ctx.AddDependency(ctx.Module(), platformResTag, "com.evervolv.platform-res")
		}
	}
		...
		case Dependency:
			...
			case platformResTag:
				if ctx.ModuleName() == "com.evervolv.platform" ||
					...
					// com.evervolv.platform.jar has a one-off dependency on the R.java and Manifest.java files
					// generated by com.evervolv.platform-res.apk
					deps.srcJars = append(deps.srcJars, dep.(*AndroidApp).aaptSrcJar)
				}
